...
**Python 原有**: 物理模拟转盘，支持多班级/多学生偏向选择

**思源版设计**:
- **1对1 优化**: MVP 阶段专注 1对1 教学，启动课程时自动关联唯一学生，无需选人流程
- **架构扩展性**: 数据结构保留 `Student-DB` 关联，支持未来扩展为多学生列表选择
- **状态同步**: 教学面板实时显示当前学生信息，所有评分操作默认归属于该学生

**价值**: ★★★☆☆ — MVP 阶段简化交互，专注核心评分逻辑
